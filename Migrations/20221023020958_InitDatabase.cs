    ...
    public partial class InitDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomsConfiguration", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_Queues_QueueId",
                        column: x => x.QueueId,
                        principalTable: "Queues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rooms_RoomsConfiguration_ConfigurationId",
                        column: x => x.ConfigurationId,
                        principalTable: "RoomsConfiguration",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_QueueId",
                table: "Rooms",
                column: "QueueId");

            migrationBuilder.CreateIndex(
                name: "IX_Videos_QueueId",
                table: "Videos",
                column: "QueueId");
        }
